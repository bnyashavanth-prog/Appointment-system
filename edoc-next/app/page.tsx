      ...
      >
        ...
        >
          <m.div 
            ...
            className={`absolute -top-[10%] -right-[5%] w-[400px] h-[400px] bg-teal-500/[0.04] rounded-full blur-[80px] ${styles.introPulseCircle}`} 
          />
          <m.div 
            animate={shouldReduceMotion ? {} : { rotate: -360 }} transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
            className={`absolute bottom-[10%] right-[15%] w-[300px] h-[300px] bg-[#E8FBF3] rounded-full blur-[60px] ${styles.introPulseCircle}`} 
          />
        ...
        <div className="flex-1 flex flex-col min-h-[100dvh] md:min-h-screen w-full relative z-10 overflow-y-auto overflow-x-hidden">
          ...
          <div className="w-full pt-8 px-6 pb-2 md:p-0 md:fixed md:top-10 md:left-10 z-[100] flex justify-start">
            <div className={`flex flex-col ${styles.introLogo}`}>
          ...
          <div className="flex-1 flex items-center justify-center p-4 py-8 md:p-6 w-full">
            <div
              className={`w-full max-w-[420px] bg-white/95 backdrop-blur-[10px] rounded-[24px] p-8 md:p-10 shadow-[0_4px_6px_rgba(0,0,0,0.03),0_12px_24px_rgba(0,0,0,0.06)] border border-white/60 ${styles.introCard} ${isShaking && !shouldReduceMotion ? styles.shake : ""}`}
              onAnimationEnd={(e) => {
