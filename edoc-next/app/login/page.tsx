...
export default function LoginPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        {/* STEP 1: Background decorative shapes — fade in 0-0.8s */}
        <m.div
          style={{ x: shiftX, y: shiftY }}
          className={`absolute inset-0 pointer-events-none z-0 hidden md:block ${styles.introBg}`}
        >
          <m.div
        ...
        {/* STEPS 2/4: Left video panel (has its own inline intro animations) */}
        <AuthBackground />
        ...
        <div className="flex-1 flex flex-col min-h-[100dvh] md:min-h-screen w-full relative z-10 overflow-y-auto overflow-x-hidden">
          ...
          {/* STEP 3: Logo — slides in from left at 1.8s */}
          ...
          {/* STEP 5: Card container — blur skeleton → resolve */}
          <div className="flex-1 flex items-center justify-center p-4 py-8 md:p-6 w-full">
            ...
            >
              ...
              {/* SKELETON PLACEHOLDER — visible during blur phase, fades out at 3.2s */}
              <div className={`absolute inset-0 rounded-[24px] bg-white/80 backdrop-blur-md flex flex-col items-center justify-start p-10 z-50 pointer-events-none ${styles.introSkeleton}`}>
                ...
                <div className="w-3/4 h-8 rounded-lg bg-slate-200/60 animate-pulse mb-3" />
                <div className="w-1/2 h-4 rounded bg-slate-200/60 animate-pulse mb-10" />
              ...
              {/* REAL CONTENT — STEP 6: staggered cascade */}
              <div className="p-8 md:p-10">
                ...
                {error && (
                  <div className="mb-5 p-3 text-sm text-red-600 bg-red-50 rounded-xl border border-red-100 text-center font-medium">
                    {error}
                  </div>
                )}
                  ...
                  <div className={`group ${styles.introEmail}`}>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="doctor@edoc.com" autoComplete="email"
                    ...
                    <div className="relative">
                      ...
                      >
                        <div className="relative w-5 h-5">
                          <m.div initial={false} animate={{ opacity: showPassword ? 1 : 0 }} transition={{ duration: 0.15 }} className="absolute inset-0"><EyeOff size={20} /></m.div>
                          <m.div initial={false} animate={{ opacity: showPassword ? 0 : 1 }} transition={{ duration: 0.15 }} className="absolute inset-0"><Eye size={20} /></m.div>
                        </div>
                      </button>
                    </div>
                  </div>
